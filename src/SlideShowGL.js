...
const TriangleSplitter = require('./TriangleSplitter');

const WaveAnimation = require('./WaveAnimation');
const FlipAnimation = require('./FlipAnimation');
//const ShiftAnimation = require('./ShiftAnimation');
const ScaleAnimation = require('./ScaleAnimation');
const FreakAnimation = require('./FreakAnimation');
const CycloneAnimation = require('./CycloneAnimation');
//const RandomAnimation = require('./RandomAnimation');
const GravityAnimation = require('./GravityAnimation');
